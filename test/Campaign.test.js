...
const compileFactory = require("../etherum/build/CampaignFactory.json");
const compileCampaign = require("../etherum/build/Campaign.json");
...
describe('Campaigns',() => {
  ...
  it('requires a minimum contriution', async()=> {
    try {
      await campaign.methods.contribute().send({
        value: '5',
        from:accounts[0]
